...
function SignUp() {
  ...
  // Password strength calculator (kept for UI feedback)
                ...
                >
                  ...
                  <div className="flex items-center justify-between text-xs">
                    ...
                    <div className="flex gap-2 text-muted-foreground">
                      ...
                      <span
                        className={`flex items-center gap-1 ${passwordStrength.checks.hasLetter ? "text-green-400" : ""}`}
                      >
                      ...
                      <span
                        className={`flex items-center gap-1 ${passwordStrength.checks.hasNumber ? "text-green-400" : ""}`}
                      >
