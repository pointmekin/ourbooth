 ...
 */
export const FILTER_CATEGORIES: { id: 'bw' | 'color' | 'vintage'; label: string; icon: string }[] = [
 ...
 */
export function getFiltersByCategory(category: 'bw' | 'color' | 'vintage'): FilterPreset[] {
