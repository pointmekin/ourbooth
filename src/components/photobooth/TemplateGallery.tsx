      ...
      <div className="flex-1 overflow-auto">
        ...
        <div className="px-6 pt-8 pb-6 md:px-12">
          <div className="mx-auto max-w-7xl">
            <h1 className="mb-3 bg-linear-to-br from-white via-white to-neutral-500 bg-clip-text text-4xl font-black tracking-tighter text-transparent md:text-6xl">
              Choose Your Frame
            </h1>
        ...
        <div className="sticky top-0 z-20 mb-8 px-0 pb-4 md:px-12">
          <div className="relative mx-auto max-w-7xl ">
            {/* Left Fade */}
            <div className="pointer-events-none absolute top-0 bottom-0 left-0 z-10 w-3 bg-linear-to-r from-neutral-950 to-transparent" />
            {/* Right Fade */}
            <div className="pointer-events-none absolute top-0 right-0 bottom-0 z-10 w-3 bg-linear-to-l from-neutral-950 to-transparent" />
            ...
            >
              <ScrollArea className="w-full whitespace-nowrap">
                <TabsList className="h-auto gap-1 bg-transparent pl-4">
                  <TabsTrigger
                    value="all"
                    className="text-foreground data-[state=active]:bg-primary data-[state=active]:text-primary-foreground rounded-full px-5 py-2.5 font-semibold data-[state=active]:shadow-lg"
                  >
                    All Styles
                  </TabsTrigger>
                  {TEMPLATE_CATEGORIES.map((cat) => (
                    <TabsTrigger
                      key={cat.id}
                      value={cat.id}
                      className="text-foreground data-[state=active]:bg-primary data-[state=active]:text-primary-foreground gap-2 rounded-full px-5 py-2.5 font-semibold data-[state=active]:shadow-lg"
                    >
  ...
  return (
    <section className="relative">
        ...
        <div className="flex items-end justify-between gap-4">
          ...
          <div className="hidden gap-2 md:flex">
            <Button
              ...
              className="h-10 w-10 rounded-full border-white/20 bg-white/5 hover:bg-white/10 disabled:opacity-30"
            >
      ...
      <div className="relative mx-auto max-w-7xl">
        {/* Left Fade */}
        <div
          className={`pointer-events-none absolute top-0 bottom-0 left-0 z-10 w-6 bg-linear-to-r from-neutral-950 to-transparent transition-opacity md:w-12 ${
        ...
        {/* Right Fade */}
        <div
          className={`pointer-events-none absolute top-0 right-0 bottom-0 z-10 w-6 bg-linear-to-l from-neutral-950 to-transparent transition-opacity md:w-12 ${
...
function TemplateCard({
  ...
  return (
    ...
    >
      {/* Card Container */}
      <Card className="relative border-white/5 bg-neutral-900/60 p-3 py-3 transition-all duration-300 group-hover:border-white/20 group-hover:bg-neutral-900 group-hover:shadow-[0_10px_40px_-15px_rgba(0,0,0,0.5)]">
        {/* Template Preview */}
        <div
        ...
        {/* Category Badge */}
        <div className="absolute -top-2 -right-2 flex h-8 w-8 items-center justify-center rounded-full border border-white/10 bg-neutral-800 text-sm shadow-lg">
          {category?.icon}
        </div>
      </Card>
      ...
      <div className="mt-3 px-1">
        <h3 className="truncate text-sm font-semibold text-white transition-colors group-hover:text-rose-400">
          {template.name}
        </h3>
