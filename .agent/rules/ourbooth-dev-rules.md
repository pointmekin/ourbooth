...
This project uses bun for package management and running.

Always use shadcn/ui components as the main component library. You can install missing components with Bun.
